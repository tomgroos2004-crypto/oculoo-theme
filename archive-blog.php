...
<main id="primary" class="site-main ls-blog-archive">

  <!-- Hero -->
  <section class="ls-blog-archive-hero section-md">
    <div class="ls-container">
      <p class="ls-blog-archive-hero__eyebrow">Blog</p>
      <h1 class="ls-blog-archive-hero__title">Blog</h1>
      <p class="ls-blog-archive-hero__sub lead">Inzichten, tips en nieuws van Oculoo.</p>
    </div>
  </section>
    ...
    <div class="ls-container">
      ...
      ?>
        <div class="ls-blog-archive-grid__filter">
          <a class="ls-blog-filter__tag <?= !is_tax('blog_categorie') ? 'is-active' : ''; ?>" href="<?= esc_url(get_post_type_archive_link('blog')); ?>">Alles</a>
              ...
              <div class="ls-blog-card__body">
                ...
                <div class="ls-blog-card__footer">
                  ...
                  <?php if (!empty($read_time)) : ?>
                    <span class="ls-blog-card__read-time"><?= (int) $read_time; ?> min</span>
                  <?php endif; ?>
                </div>
              </div>
            </a>
      ...
      <?php else : ?>
        <div class="ls-blog-empty">
          <p>Er zijn nog geen blogs gepubliceerd.</p>
        </div>
      <?php endif; ?>
